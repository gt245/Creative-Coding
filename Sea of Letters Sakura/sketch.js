...
function preload(){
  ...
  myFont = loadFont("assets/bonzai.ttf")
...
function letter(){
  ...
  textAlign(CENTER);
  textSize(80);
  text("Write a letter to your future self...", window.innerWidth/4, 70, window.innerWidth/2, window.innerHeight);
  fill(0);
  textSize(40);
  text("Press the right arrow key to send off your letter-sakura.", window.innerWidth/4, window.innerHeight - 130, window.innerWidth/2, window.innerHeight);
